...
<body>
    ...
    <main>
        ...
        <div class="containerVenda">
            <div class="title">Por que vender na <span>Daterra</span>?</div>

            <div class="containerBox">
                <div class="box1">
                    <div class="mainBox1">
                        <img src="img/mark-sivewright-xMjQYjGGJgk-unsplash.jpg" alt="">
                    </div>

                    <div class="mainBox2">
                        <h5>Tecnologia</h5>
                        <p>Evolua e otimize seu negócio com a Daterra e se destaque no meio agrícola com inovação.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="containerBox">
                <div class="box1">
                    <div class="mainBox2">
                        <h5>Agilidade</h5>
                        <p>Venda produtos agrícolas de maneira mais simples, com mais conforto e praticidade, dentro de sua própria casa.</p>
                    </div>

                    <div class="mainBox1">
                        <img src="img/irina-shishkina-qaFULIsrUc0-unsplash.jpg" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="containerBox">
                <div class="box1">
                    <div class="mainBox1">
                        <img src="img/karsten-wurth-UbGYPMbMYP8-unsplash.jpg" alt="">
                    </div>
        
                    <div class="mainBox2">
                        <h5>Renda Extra</h5>
                        <p>Conquiste novos clientes e aumente sua renda de forma prática e eficiente, acessando um novo mercado. </p>
                    </div>
                </div>
            </div>
        </div>

        <div class="title"><span>Cadastre-se</span> para vender.</div>

        <div class="formulario">

            <div class="formularioBox">

                <form method="POST" action="php/processa_vendedor.php">
                    ...
                    <div>
                        <label for="nome">Nome comercial:</label><br>
                        <input type="text" name="nomec" id="nomec" placeholder="Nome do seu comércio ou seu nome." required/>
                    </div>
